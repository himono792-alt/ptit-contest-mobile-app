...
**API (Docker local):** http://localhost:8000 — `docker compose up -d` tại root repo (production Railway đã ngừng 2026-06-11)
...
- **Schema SQL**: `../database/2026-05-06_sqlapp_v04.sql`
- **ER diagram**: `../database/2026-05-04_er-diagram_v02.mermaid`
- **Traceability matrix**: `../docs/requirements/2026-05-07_traceability-matrix_v03.md`
- **Workflow approval**: `../docs/architecture/2026-05-04_workflow-approval-overview_v01.md`
